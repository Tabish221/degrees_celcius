   ...
   <section class="mainBanner">
      <div class="container">
         <div class="mainBanner-cont">
            <h2>WELCOME TO Degrees Celcius <span class="wave">👋</span></h2>
            <h1>Meet Your <br> New Comic Book Hero</h1>
            <p>Discover a world of thrilling adventures and unforgettable characters. Join our protagonist on their epic quest With stunning visuals and captivating storytelling, this comic series will leave you wanting more.</p>

            <a href="about-us.php" class="themeBtn alt">
         ...
         <div class="row align-items-center">
            <div class="col-md-7">
               <div class="featureSec-img">
                  <img src="assets/images/feature/img1.jpg" alt="Featured Images">
                  <img src="assets/images/feature/img2.jpg" alt="Featured Images">
               </div>
            </div>

            <div class="col-md-5">
               <div class="featureSec-cont">
                  <span class="fs-xs">FEATURED COMICS</span>
                  <h4 class="fs-lg">Announcing Goodyng: The Polymath</h4>
                  <p class="fs-p1">Discover a world of thrilling adventures and unforgettable characters. Join our protagonist on their epic quest With stunning visuals and captivating storytelling, this comic series will leave you wanting more.</p>

                  <a href="about-us.php" class="themeBtn">
                     <span class="button-text">READ MORE</span>
                     <div class="corner bottom-left"></div>
                     <div class="corner top-right"></div>
                  </a>
      ...
      <div class="container">
         <div class="discoverSec-hd">
            <div class="row align-items-center">
               <div class="col-md-4">
                  <div class="cont">
                     <span class="fs-xs">Comics</span>
                     <h4 class="fs-lg text-white">Discoover All Comics</h4>
                  </div>
               </div>
                  ...
                  <div class="discoverSec-hdRight">
                     ...
                     <div class="discoverSec-nav">
                        <ul>
                           ...
                           <li data-tabing="Alphacore"><a href="#">Alphacore</a></li>
                           <li data-tabing="Goodyng"><a href="#">Goodyng</a></li>
                           <li data-tabing="ISOM"><a href="#">ISOM</a></li>
                           <li data-tabing="Yaira"><a href="#">Yaira</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
         ...
         <div class="discoverSec-main">
            ...
            <div class="row">
               <div class="col-md-3" data-showing="Alphacore" data-dis-search="Alphacore, elba, showko">
                  <a href="comics.php" class="w-100">
                     <div class="discoverSec-card">
                        <div class="img">
                           <img src="assets/images/discover/img1.jpg" alt="Discover Comics">
                        </div>

                        <div class="cont">
                           <h6 class="fs-sm">ALPHACORE #1</h6>
                        </div>
                     </div>
                  </a>
               </div>

               <div class="col-md-3" data-showing="Goodyng" data-dis-search="Goodyng">
                  <a href="comics.php" class="w-100">
                     <div class="discoverSec-card">
                        <div class="img">
                           <img src="assets/images/discover/img2.jpg" alt="Discover Comics">
                        </div>

                        <div class="cont">
                           <h6 class="fs-sm">Bloodruth</h6>
                        </div>
                     </div>
                  </a>
               </div>

               <div class="col-md-3" data-showing="ISOM" data-dis-search="ISOM">
                  <a href="comics.php" class="w-100">
                     <div class="discoverSec-card">
                        <div class="img">
                           <img src="assets/images/discover/img3.jpg" alt="Discover Comics">
                        </div>

                        <div class="cont">
                           <h6 class="fs-sm">The Polymath</h6>
                        </div>
                     </div>
                  </a>
               </div>

               <div class="col-md-3" data-showing="Yaira" data-dis-search="Yaira">
                  <a href="comics.php" class="w-100">
                     <div class="discoverSec-card">
                        <div class="img">
                           <img src="assets/images/discover/img4.jpg" alt="Discover Comics">
                        </div>

                        <div class="cont">
                           <h6 class="fs-sm">ISOM #1</h6>
                        </div>
                     </div>
                  </a>
               </div>
            ...
            <div class="row">
               <div class="col-md-5">
                  <div class="characterSec-cont">
                     <span class="fs-xs">WIKI</span>
                     <h4 class="fs-lg">Meet all of <br> our <br> characters</h4>
                     <p>Discover a world of thrilling adventures and unforgettable characters. Join our protagonist on their epic quest With stunning visuals and captivating storytelling, this comic series will leave you wanting more.</p>
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="characterSec-card">
                                 <div class="img">
                                    <img src="assets/images/character/comic1.png" alt="Comic Character">
                                 </div>
         
                                 <div class="cont">
                                    <h6 class="fs-sm"><span>Character Name</span></h6>
                                    <a href="wiki.php">
                           ...
                           <div class="swiper-slide">
                              <div class="characterSec-card">
                                 <div class="img">
                                    <img src="assets/images/character/comic2.png" alt="Comic Character">
                                 </div>
                           ...
                           <div class="swiper-slide">
                              <div class="characterSec-card">
                                 <div class="img">
                                    <img src="assets/images/character/comic3.png" alt="Comic Character">
                                 </div>
   ...
   <section class="testimonialSection">
      <div class="container">
         <div class="testimonialSec-hd">
            <span class="fs-xs">TESTIMONIALS</span>
            <h4 class="fs-lg">Reader Reviews and Comments</h4>
            <p class="fs-p1">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type Lorem Ipsum has been the industry's standard.</p>
         </div>
      </div>
               ...
               <div class="swiper-wrapper">
                  <div class="swiper-slide">
                     <div class="testimonialSec-card">
                        <div class="img">
                           <img src="assets/images/testimonials/img1.jpg" alt="Client Profile">
                        </div>
                        ...
                        <div class="cont">
                           ...
                           <p class="fs-p2">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a typ</p>
                  ...
                  <div class="swiper-slide">
                     <div class="testimonialSec-card">
                        <div class="img">
                           <img src="assets/images/testimonials/img2.jpg" alt="Client Profile">
                        </div>
                  ...
                  <div class="swiper-slide">
                     <div class="testimonialSec-card">
                        <div class="img">
                           <img src="assets/images/testimonials/img3.jpg" alt="Client Profile">
                        </div>
   ...
   <section class="gallerySection">
      <div class="container">
         <div class="gallerySec-hd">
            <span class="fs-xs">Gallery</span>
            <h4 class="fs-lg">Some of our work</h4>
            <p class="fs-p1">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type Lorem Ipsum has been the industry's standard.</p>
         </div>

         <div class="gallerySec-main">
            <a href="assets/images/gallery/himg1.jpg" data-fancybox="Gallery" class="gallerySec-imageCard">
               <img src="assets/images/gallery/himg1.jpg" alt="Gallery Image">
            </a>

            <a href="assets/images/gallery/himg2.jpg" data-fancybox="Gallery" class="gallerySec-imageCard">
               <img src="assets/images/gallery/himg2.jpg" alt="Gallery Image">
            </a>

            <a href="assets/images/gallery/himg3.jpg" data-fancybox="Gallery" class="gallerySec-imageCard">
               <img src="assets/images/gallery/himg3.jpg" alt="Gallery Image">
            </a>

            <a href="assets/images/gallery/himg4.jpg" data-fancybox="Gallery" class="gallerySec-imageCard">
               <img src="assets/images/gallery/himg4.jpg" alt="Gallery Image">
            </a>

            <a href="assets/images/gallery/himg5.jpg" data-fancybox="Gallery" class="gallerySec-imageCard">
               <img src="assets/images/gallery/himg5.jpg" alt="Gallery Image">
            </a>
         </div>

         <div class="gallerySec-bottom">
            <a href="gallery.php" class="themeBtn">
               <span class="button-text">See all</span>
               <div class="corner bottom-left"></div>
               <div class="corner top-right"></div>
            </a>
